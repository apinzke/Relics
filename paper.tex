...
\begin{minipage}{2.0\columnwidth}
  ...
  \caption{Testing the robustness of the CR electron spectra. Left
    ...
    between snapshots. \AP{Do we want to put these figures in an
...
\begin{figure}
  ...
  \caption{Spatial dependence of the cosmic ray electron spectra at
    ...
    the CR electron spectra for different radial bins. \AP{We might
      want to put this type of figure in the second
